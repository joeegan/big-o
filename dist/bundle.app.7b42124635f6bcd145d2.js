...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__quick_sort__ = __webpack_require__(10);
...
function oLogN(n) {
  ...
  for (let i = 2; i < n+3; i++) {
    ...
    results.push([i-2, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__binary_search__["a" /* default */])(0, arr).iterationCount]);
  }
  return results;
}
...
function oNLogN(n) {
  const results = [['Operations', 'Array length']];
  for (let i = 1; i < n+1; i++) {
    results.push([i, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__quick_sort__["a" /* default */])(new Array(i)).iterationCount]);
  }
  return results;
}
...
window.onload = function() {
  ...
  window.binarySearch = __WEBPACK_IMPORTED_MODULE_2__binary_search__["a" /* default */];
...
/***/ }
/******/ ]);
//# sourceMappingURL=bundle.app.7b42124635f6bcd145d2.js.map